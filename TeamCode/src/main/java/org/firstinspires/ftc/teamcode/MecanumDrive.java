...
public final class MecanumDrive {
    public static class Params {
        ...
        public double trackWidthTicks =  12821.65259233; //6792.336835156452; //6792.336835156452; // empirical: 6934.745424181346//actual: 4800.4222;wheel center to center 6821.6526
        ...
        public double kV =  0.001;//0.000262869212788957 ;//0.0005628692127889575; // 0.0003628692127889575;//0.000200;//0.0003450079827757681;
                                                    // alachua
        public double kA = 0.00006; //0.00006;  //0.00004;

        // path profile parameters (innches)
        public double maxWheelVel = 115;//125; // 85
        public double minProfileAccel = -80;//-80; // -60
        public double maxProfileAccel = 100;//110; // 70

        // turn profile parameters (in radians)
        public double maxAngVel = Math.PI*60; // shared with path
        public double maxAngAccel = Math.PI*16;

        // path controller gains
        public double axialGain = 7;//7;
        public double lateralGain = 7;//7;
        public double headingGain = 3.5;//3; // shared with turn

        public double axialVelGain = 1;//1;
        public double lateralVelGain = 1;//1;
        public double headingVelGain = .5;//.25; // shared with turn
    }
